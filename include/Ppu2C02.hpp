...
class Ppu2C02 : public Device
{
    ...
    protected:
        ...
        enum PpuCtrlBits
        {
            BASE_NAMETBL    = 0x3,      // Base nametable address (0 = $2000; 1 = $2400; 2 = $2800; 3 = $2C00).
        ...
        enum PpuStatusBits
        {
            OPEN_BUS        = 0x1F,     // PPU open bus. Returns stale PPU bus contents.
        ...
        // 4 logical name tables in total. The 3rd and 4th tables would be located on the cartridge. The first index in mNameTable
        ...
        // to get color information from the pallete/attribute tables?, and are typically referred as "left" (first pattern table) and "right"
